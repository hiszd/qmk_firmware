...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_wrapper(
        ...
        MT_CTL,  __________________QWERTY_L2___________________,       __________________QWERTY_R2___________________, KC_QUOT, KC_LEAD,          KC_PGDN,
        KC_LSPO, __________________QWERTY_L3___________________,       __________________QWERTY_R3___________________, KC_RSPC,          KC_UP,
      MO(2),             KC_LALT,                 KC_UNDS,    KC_SPC,  KC_ENT,                KC_RGUI,                          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_NUMPAD] = LAYOUT_wrapper(
        KC_TILD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  RESET,            _______, _______, _______,
	    ...
	    _______,          _______,                  _______,    _______, _______,                   _______,                   _______,   TG_GAM, _______
    ),
